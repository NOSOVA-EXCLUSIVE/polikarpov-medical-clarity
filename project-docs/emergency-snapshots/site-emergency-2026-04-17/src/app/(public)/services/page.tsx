...
const primaryFormats = [
  ...
  },
  {
    ...
    situation: "Когда важно выбрать правильную тактику.",
    action:
      "Врач анализирует жалобы, симптомы и обследования, сопоставляет данные МРТ / КТ / рентгена с клинической картиной и выстраивает обоснованную тактику.",
    accent: "👉 Когда нужен не просто ответ, а профессионально выстроенный следующий шаг",
    priceLead: "Оптимальный формат для решения задачи",
    standardPrice: "9 000 ₽",
    currentPrice: "5 900 ₽",
    euroPrice: "≈ 60 €",
    result: "Вы получаете чёткую тактику лечения."
  }
] as const;
...
const premiumFormats = [
  {
    ...
    action:
      "Врач оценивает динамику восстановления, сопоставляет жалобы, этап лечения и текущие изменения, помогает удерживать правильный курс.",
  ...
  },
  {
    ...
    accent: "👉 Когда нужна не разовая консультация, а более внимательное ведение ситуации",
    priceLead: "Оптимальный формат для решения задачи",
    standardPrice: "75 000 ₽",
    currentPrice: "от 50 000 ₽",
    euroPrice: "≈ 520 €",
    result: "Состояние пациента находится под системным контролем.",
    premiumDepth: "Формат предполагает более глубокую работу и регулярное взаимодействие с врачом",
...
const orientationScenarios = [
  ...
  {
    title: "Если нужен контроль лечения",
      ...
      <section className="section services-page__simple-intro">
        <div className="container stack">
          ...
          <div className="stack-sm">
            <div className="services-page__intro-copy stack-xs">
              <p>Вам не нужно угадывать, какой формат выбрать.</p>
              <p>Каждый из них решает конкретную клиническую задачу.</p>
            </div>
          ...
          <p className="services-formats-shell__note">Точный формат определяется после первичного разбора.</p>
        </div>
      </section>
