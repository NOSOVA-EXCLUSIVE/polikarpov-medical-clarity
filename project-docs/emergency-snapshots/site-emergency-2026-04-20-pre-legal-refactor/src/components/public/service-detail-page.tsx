...
export function ServiceDetailPage({ service }: ServiceDetailPageProps) {
  return (
    <main className={`service-detail-page service-detail-page--${service.slug}`}>
      <PageHero
        ...
        aside={
          <div className="card card--price service-detail-price-aside stack-sm">
            ...
            {service.euroPrice ? (
              <p className="service-detail-price-aside__euro">{service.euroPrice}</p>
            ) : null}
            <p className="muted">
              Начало работы — через анкету пациента и просмотр материалов.
            </p>
          </div>
        }
      />
      ...
      <Section id="service-process" title="Как проходит работа">
        <div
          className={`service-detail-process-grid service-detail-process-grid--${service.process.length}`}
        >
      ...
      <Section id="service-price" title="Стоимость">
        <div className="two-column service-detail-two-column">
          <article className="card service-detail-price-card stack-sm">
            ...
            {service.euroPrice ? (
              <p className="service-detail-price-card__euro">{service.euroPrice}</p>
            ) : null}
            <p>Оплата осуществляется после первичного разбора и подтверждения формата.</p>
          </article>
          <article className="card service-detail-inline-cta stack-sm">
            <p>
              Анкета позволяет врачу понять ситуацию и подтвердить, что именно этот формат
      ...
      <div className="container service-detail-choice-note">
        <p className="service-detail-choice-note__text">
          Если вы не уверены в выборе формата — врач уточнит его после анализа анкеты.
        </p>
        <p className="service-detail-choice-note__text">
          Рекомендации носят ознакомительный характер. Окончательные решения принимаются
            ...
            <div className="services-final-cta__copy stack-sm">
              <h2>
                <span className="services-final-cta__line">
                  Если этот формат соответствует вашей ситуации,
                </span>
                <span className="services-final-cta__line">
              ...
              <p className="services-final-cta__lead">
                Врач сначала изучит ситуацию и материалы, затем подтвердит, подходит ли этот
