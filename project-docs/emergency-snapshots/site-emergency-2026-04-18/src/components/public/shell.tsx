    ...
    <header className="site-header">
      <div className="container site-header__inner">
        <div className="site-brand">
          ...
          <div className="site-brand__subtitle">
      ...
      <div className="container site-footer__frame">
        <div className="site-footer__top">
          <div className="site-footer__identity">
            ...
            <p className="site-footer__copy">Цифровой формат для точного разбора сложной ситуации</p>
          </div>
        ...
        <div className="site-footer__bottom">
          <div className="site-footer__legal-meta">
            ...
            <p className="site-footer__legal-note">
              Онлайн-консультация носит информационно-консультационный характер и не заменяет очный приём
              врача.{" "}
