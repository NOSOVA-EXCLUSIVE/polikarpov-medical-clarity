        ...
        <div className="container stack">
          <section className="page-hero">
            <div className="page-hero__grid">
              <div className="stack">
                ...
                <p className="lead">
                  Врач уже посмотрел ваш случай и подготовил персональное предложение. Здесь можно спокойно выбрать удобный слот, после чего откроется защищённая страница оплаты.
                </p>
              </div>
          ...
          {query.cancelled ? (
            <div className="notice">
              <p>Оплата не завершилась. Если ссылка ещё активна, можно снова выбрать слот и перейти к оплате по этой же персональной ссылке.</p>
            </div>
          ) : null}
              ...
              <form action={`/api/booking/${token}/checkout`} className="stack" method="post">
                ...
                <div className="hero-actions">
                  <button className="button" type="submit">
                    Удержать слот и перейти к оплате
                  </button>
