      ...
      return (
        <>
          <div className="questionnaire-panel__header stack-sm">
            <h2>Перед началом</h2>
            <p>Вы сейчас отправляете информацию на первичный клинический разбор.</p>
        ...
        <>
          <div className="questionnaire-panel__header stack-sm">
            ...
            <p className="questionnaire-panel__intro">
              <span className="questionnaire-panel__line questionnaire-panel__line--nowrap">Эти данные помогают врачу оценить ситуацию не отдельно по одному симптому,</span>
        ...
        <>
          ...
          <div className="checkbox-grid">
            ...
            <label className="checkbox-row">
              ...
              <span>Я понимаю формат онлайн-консультации</span>
            </label>
            <label className="checkbox-row">
          ...
          <div className="notice stack-sm">
            ...
            <ol className="questionnaire-next-list">
              ...
              <li>Оценит, подходит ли онлайн-формат в вашем случае</li>
          ...
          <div className="card questionnaire-success-card stack">
            ...
            <div className="questionnaire-success-card__section stack-sm">
              ...
              <ul className="questionnaire-success-list">
                <li>профессиональное мнение врача</li>
