  ...
  return (
    <main>
      <PageHero
        ...
        title="Первичный профессиональный разбор вашей ситуации"
        description={
          <>
            <span className="questionnaire-hero__line questionnaire-hero__line--primary">
              Спокойно и последовательно соберём полную картину ситуации, чтобы понять, что происходит и какой формат помощи будет для вас уместен
            </span>
