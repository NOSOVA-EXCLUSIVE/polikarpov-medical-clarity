...
export const QUESTIONNAIRE_LEAD_STATUSES = {
  new: {
    code: "new",
    label: "Новая анкета",
    description: "Анкета получена и ожидает первичного профессионального разбора ситуации."
  },
  in_review: {
    code: "in_review",
    label: "На разборе",
    description: "Врач изучает ситуацию, материалы и общий контекст."
  },
  contacted: {
    code: "contacted",
...
В ближайшее время предложу удобное время для согласованного формата работы.`
} as const;
